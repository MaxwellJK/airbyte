...
@dataclass
class MyHttpRequester(Requester):
    """
    ...
    def send_request(
        ...
        print(path)
        print(self.get_path(stream_state=stream_state, stream_slice=stream_slice, next_page_token=next_page_token))
        print(self._request_params(stream_state, stream_slice, next_page_token, request_params))
